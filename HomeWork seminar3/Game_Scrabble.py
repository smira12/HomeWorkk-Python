...
list_Eng = {'AEIOULNSTR': 1, 'DG': 2, 'BCMP': 3,
            'FHVWY': 4, 'K': 5, 'JX': 8, 'QZ': 10}
list_Rus = {'АВЕИНОРСТ': 1, 'ДКЛМПУ': 2, 'БГЁЬЯ': 3,
            'ЙЫ': 4, 'ЖЗХЦЧ': 5, 'ШЭЮ': 8, 'ФШЪ': 10}

eng = 'qwertyuiopasdfghjklzxcvbnm'
rus = 'йцукенгшщзхъфывапролджэячсмитьбюё'

keyword = input('Введите слово на русском или английском языке: ')
summa = 0
if keyword[0].lower() in eng:
